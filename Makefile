...
help:
	...
	@echo "  benchmark-foundation  Phase 28 APEX vs general-purpose models -> docs/benchmark/"
...
longitudinal:
	python scripts/longitudinal_eval.py
...
synth-ablation:
	python scripts/synth_ablation.py
...
# Hosted arms need OPENAI_API_KEY / ANTHROPIC_API_KEY; without them they are recorded
# as "not run" rather than silently omitted.
benchmark-foundation:
	python scripts/foundation_benchmark.py
